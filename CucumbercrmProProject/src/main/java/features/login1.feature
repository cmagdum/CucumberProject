...
@positive 
Scenario: Parameter testing with valid credentials (Parameterizing without Example Keyword)
...
Scenario Outline:: Test login frm pro with valid credentials (Parameterization with Example Keyword)
	...
	|browsername| url| UserId| UserPass|wait|Title|
	|Chrome| https://www.crmpro.com|Mayuri_257|Mayuri$|15 seconds|CRMPRO|	